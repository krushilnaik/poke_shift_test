...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : e(
        ((t = "undefined" != typeof globalThis ? globalThis : t || self).Motion = {}),
        t.React
      );
})(this, function (t, e) {
  "use strict";
            ...
            return e.useCallback(
              (e) => {
                e && t.mount && t.mount(e),
                  ...
                  s && ("function" == typeof s ? s(e) : d(s) && (s.current = e));
              },
              [n]
            );
          })(w, P.visualElement, f),
  ...
  function L(t) {
    return (
      "string" == typeof t && !t.includes("-") && !!(D.indexOf(t) > -1 || /[A-Z]/.test(t))
    );
  }
  const R = {};
  function k(t) {
  ...
  function At(t, n, s, i) {
    const o = e.useMemo(() => {
      ...
      return (
        Et(e, n, { enableHardwareAcceleration: !1 }, St(i), t.transformTemplate),
  ...
  function Rt(t, e) {
    ...
    for (const s in t)
      if (O(t[s]) || O(e[s])) {
        n[-1 !== B.indexOf(s) ? "attr" + s.charAt(0).toUpperCase() + s.substring(1) : s] =
          t[s];
      }
    return n;
  }
  ...
  function Ft(t) {
    const e = O(t) ? t.get() : t;
    return (
      (n = e), Boolean(n && "object" == typeof n && n.mix && n.toValue) ? e.toValue() : e
    );
    var n;
  }
  const Ot = (t) => (n, s) => {
  ...
  const {
      ...
      const i = { delta: 0, timestamp: 0, isProcessing: !1 },
              ...
              const r = new WeakSet(),
                a = {
                  schedule: (t, o = !1, a = !1) => {
                    ...
                    return (
                      o && r.add(t),
                      -1 === u.indexOf(t) && (u.push(t), l && i && (s = e.length)),
                      t
                    );
                  },
                  cancel: (t) => {
                  ...
                  process: (l) => {
                    if (i) o = !0;
                      ...
                      if (
                        ((i = !0), ([e, n] = [n, e]), (n.length = 0), (s = e.length), s)
                      )
                        for (let n = 0; n < s; n++) {
                          const s = e[n];
        ...
        a = () => {
          ...
          (n = !1),
            (i.delta = s ? 1e3 / 60 : Math.max(Math.min(o - i.timestamp, 40), 1)),
            (i.timestamp = o),
            (i.isProcessing = !0),
            Wt.forEach(r),
            (i.isProcessing = !1),
      ...
      return {
        schedule: Wt.reduce((e, r) => {
          ...
          return (
            (e[r] = (e, o = !1, r = !1) => (
              n || ((n = !0), (s = !0), i.isProcessing || t(a)), l.schedule(e, o, r)
            )),
            e
          );
        }, {}),
    ...
    })("undefined" != typeof requestAnimationFrame ? requestAnimationFrame : Ut, !0),
    Yt = {
      useVisualState: Ot({
  ...
  function pe(t, e, n) {
    const s = (function ({ root: t, ...e }) {
      ...
      const s = he.get(n),
        i = JSON.stringify(e);
      return s[i] || (s[i] = new IntersectionObserver(me, { root: t, ...e })), s[i];
    })(e);
    return (
      ce.set(t, n),
      s.observe(t),
              ...
              const n = this.node.getProps(),
                s = Jt(
                  ...
                  (t, e) => {
                    ...
                    Nt.update(() => {
                      le(this.node.current, t.target) ? n && n(t, e) : s && s(t, e);
                    });
                  },
                  { passive: !(n.onTap || n.onPointerUp) }
                ),
                i = Jt(window, "pointercancel", (t, e) => this.cancelPress(t, e), {
            ...
            (this.startAccessiblePress = () => {
              const t = qt(this.node.current, "keydown", (t) => {
                  ...
                  this.removeEndListeners(),
                    (this.removeEndListeners = qt(this.node.current, "keyup", (t) => {
                      "Enter" === t.key &&
                        this.checkPressEnd() &&
                        ue("up", (t, e) => {
  ...
  function Te(t) {
    return Boolean(
      !t || ("string" == typeof t && Ve[t]) || Ae(t) || (Array.isArray(t) && t.every(Te))
    );
  }
  ...
  const Le = (t, e, n) => (((1 - 3 * n + 3 * e) * t + (3 * n - 6 * e)) * t + 3 * e) * t;
  function Re(t, e, n, s) {
    ...
    const i = (e) =>
      (function (t, e, n, s, i) {
        let o,
          ...
          a = 0;
        do {
          (r = e + (n - e) / 2), (o = Le(r, s, i) - t), o > 0 ? (n = r) : (e = r);
  ...
  const ke = Re(0.42, 0, 1, 1),
    ...
    He = Ie(ze),
    $e = Oe(He),
    Ye = (t) => ((t *= 2) < 1 ? 0.5 * He(t) : 0.5 * (2 - Math.pow(2, -10 * (t - 1)))),
    Xe = {
      linear: Ut,
      easeIn: ke,
      easeInOut: je,
  ...
  const Je = {
    ...
    tn = {
      ...
      parse: (t) => (_e.test(t) ? _e.parse(t) : Qe.test(t) ? Qe.parse(t) : Je.parse(t)),
      transform: (t) =>
        ...
        (s = (function ({ hue: t, saturation: e, lightness: n, alpha: s }) {
          ...
          if ((e /= 100)) {
            const s = n < 0.5 ? n * (1 + e) : n + e - n * e,
              a = 2 * n - s;
            (i = nn(a, s, t + 1 / 3)), (o = nn(a, s, t)), (r = nn(a, s, t - 1 / 3));
          } else i = o = r = n;
          return {
  ...
  const gn = {
      test: function (t) {
        ...
        return (
          isNaN(t) &&
          Q(t) &&
          ((null === (e = t.match(K)) || void 0 === e ? void 0 : e.length) || 0) +
            ((null === (n = t.match(_)) || void 0 === n ? void 0 : n.length) || 0) >
            0
        );
      },
      parse: mn,
  ...
  const xn = (t, e) => {
    ...
    Pn = (t, e) => {
      const n = { ...t, ...e },
        s = {};
      for (const i in n) void 0 !== t[i] && void 0 !== e[i] && (s[i] = vn(t[i], e[i]));
      return (t) => {
  ...
  function Vn({ duration: t = 300, keyframes: e, times: n, ease: s = "easeInOut" }) {
  ...
  function Ln({ duration: t = 800, bounce: e = 0.25, velocity: n = 0, mass: s = 1 }) {
    let i, o;
    Pe(t <= Ee(10));
    let r = 1 - e;
    (r = Y(0.05, 1, r)),
    ...
    if (((t = Ee(t)), isNaN(a))) return { stiffness: 100, damping: 10, duration: t };
    {
  ...
  function On({
    ...
    const h = t[0],
      d = { done: !1, value: h },
      m = (t) =>
        void 0 === a ? l : void 0 === l || Math.abs(a - t) < Math.abs(l - t) ? a : l;
    let p = n * e;
    const f = h + p,
      g = void 0 === r ? f : r(f);
    g !== f && (p = g - h);
  ...
  function Yn(t, e, { onUpdate: n, onComplete: s, ...i }) {
    ...
    if (((t, e) => "spring" === e.type || "backgroundColor" === t || !Te(e.ease))(e, i)) {
  ...
  const Xn = { type: "spring", stiffness: 500, damping: 25, restSpeed: 10 },
    ...
    Kn = (t, e) =>
      ...
      (!("number" != typeof e && !Array.isArray(e)) ||
        !("string" != typeof e || (!gn.test(e) && "0" !== e) || e.startsWith("url("))),
  ...
  function ss(t, e) {
    let n = ns(t);
    return n !== ts && (n = gn), n.getAnimatableNone ? n.getAnimatableNone(e) : void 0;
  }
  ...
  const as =
    ...
    (i) => {
      ...
      const l = (function (t, e, n, s) {
          ...
          for (let t = 0; t < o.length; t++)
            null === o[t] && (o[t] = 0 === t ? r : o[t - 1]),
              os(o[t]) && l.push(t),
              "string" == typeof o[t] && "none" !== o[t] && "0" !== o[t] && (a = o[t]);
          if (i && l.length && a)
      ...
      if (
        ...
        return (function ({ keyframes: t, delay: e, onUpdate: n, onComplete: s }) {
          const i = () => (
            n && n(t[t.length - 1]),
            s && s(),
            {
  ...
  const gs = (t) => (e) => e.test(t),
    ys = [X, st, nt, et, ot, it, { test: (t) => "auto" === t, parse: (t) => t }],
    vs = (t) => ys.find(gs(t)),
    xs = [...ys, tn, gn];
  function Ps(t, e, n) {
    ...
    if (r)
      for (let l = 0; l < r; l++) {
        ...
        Array.isArray(u) && (c = u[0]),
          null === c &&
            (c =
              null !== (i = null !== (s = n[r]) && void 0 !== s ? s : t.readValue(r)) &&
              void 0 !== i
                ? i
                : e[r]),
          null != c &&
  ...
  function ks(t) {
    let e = (function (t) {
      return (e) => Promise.all(e.map(({ animation: e, options: n }) => Ds(t, e, n)));
    })(t);
    const n = {
      animate: js(!0),
      whileInView: js(),
    ...
    function o(o, r) {
      ...
      for (let e = 0; e < Rs; e++) {
        ...
        (g.prevProp = y),
          ...
          E &&
            !P &&
            u.push(...b.map((t) => ({ animation: t, options: { type: f, ...o } })));
      }
      if (c.size) {
        const e = {};
        c.forEach((n) => {
  ...
  class Ai {
        ...
        (o = (function (t, { min: e, max: n }, s) {
          return (
            void 0 !== e && t < e
              ...
              : void 0 !== n && t > n && (t = s ? en(n, t, s.max) : Math.min(t, n)),
            t
          );
    ...
    getAxisMotionValue(t) {
      const e = "_drag" + t.toUpperCase(),
        ...
        s = n[e];
      return (
        s || this.visualElement.getValue(t, (n.initial ? n.initial[t] : void 0) || 0)
      );
    }
    snapToCursor(t) {
      ri((e) => {
    ...
    addListeners() {
      ...
      const i = qt(window, "resize", () => this.scalePositionWithinConstraints()),
  ...
  function Ii(t, e, n, s, i) {
    return (t = mi((t -= e), 1 / n, s)), void 0 !== i && (t = mi(t, 1 / i, s)), t;
  }
  ...
  function Qi(t, e, n) {
    ...
    if ("string" == typeof t) {
      ...
      e && (we(Boolean(e.current)), (i = e.current)),
        n
          ? ((null !== (s = n[t]) && void 0 !== s) || (n[t] = i.querySelectorAll(t)),
            (t = n[t]))
      ...
      (i.forEach((i) => {
        ...
        if (jt(h)) {
          ...
          for (let n = e; n < t && null !== h[n]; n++)
            d ? we(vs(h[n]) === d) : ((d = vs(h[n])), we(d === c || (uo(c) && uo(d))));
        } else d = vs(h);
        if (c !== d)
          if (uo(c) && uo(d)) {
            const t = l.get();
  ...
  class To {
    constructor(
      { parent: t, props: e, presenceContext: n, reducedMotionConfig: s, visualState: i },
      o = {}
    ) {
      (this.current = null),
    ...
    loadFeatures({ children: t, ...e }, n, s, i) {
      ...
      for (let t = 0; t < bo; t++) {
        const n = Eo[t],
          { isEnabled: s, Feature: i, ProjectionNode: a, MeasureLayout: l } = E[n];
        a && (o = a),
          s(e) &&
            (!this.features[n] && i && (this.features[n] = new i(this)), l && (r = l));
      }
    ...
    update(t, e) {
      ...
      (this.prevMotionValues = (function (t, e, n) {
        ...
        for (const i in e) {
          ...
          else if (O(r)) t.addValue(i, fs(o, { owner: t })), ls(s) && s.remove(i);
          else if (r !== o)
            if (t.hasValue(i)) {
    ...
    addVariantChild(t) {
      ...
      if (e)
        return (
          e.variantChildren && e.variantChildren.add(t), () => e.variantChildren.delete(t)
        );
    }
    addValue(t, e) {
      e !== this.values.get(t) && (this.removeValue(t), this.bindToMotionValue(t, e)),
        this.values.set(t, e),
    ...
    readValue(t) {
      ...
      return void 0 === this.latestValues[t] && this.current
        ? null !== (e = this.getBaseTargetFromProps(this.props, t)) && void 0 !== e
          ? e
    ...
    on(t, e) {
      return this.events[t] || (this.events[t] = new ds()), this.events[t].add(e);
    }
    notify(t, ...e) {
      ...
      (function (t, { defaultTransition: e = {}, ...n } = {}, s) {
        ...
        for (let n = 0; n < t.length; n++) {
          ...
          const g = (t, n, s, o = 0, r = 0) => {
            const a = Wo(t),
              { delay: l = 0, times: u = Cn(a), type: d = "keyframes", ...m } = n;
  ...
  function Jo(t, e) {
    Zo || ("undefined" != typeof ResizeObserver && (Zo = new ResizeObserver(_o)));
    const n = Qi(t);
    return (
      n.forEach((t) => {
        let n = qo.get(t);
        n || ((n = new Set()), qo.set(t, n)), n.add(e), null == Zo || Zo.observe(t);
      }),
      () => {
        n.forEach((t) => {
          const n = qo.get(t);
  ...
  function lr(t, e, n, s) {
    ...
    return (
      "number" == typeof t
        ? (i = [t, t])
        : "string" == typeof t &&
          (i = (t = t.trim()).includes(" ") ? t.split(" ") : [t, or[t] ? t : "0"]),
      (o = rr(i[0], n, s)),
      (r = rr(i[1], e)),
      o - r
    );
          ...
          ? (function (t, e) {
              ...
              for (; s && s !== e; )
                if (s instanceof HTMLElement)
                  ...
                  for (n.x += e, n.y += t; s && "svg" !== s.tagName; ) s = s.parentNode;
                }
              return n;
            })(i, t)
          : ur,
  ...
  function wr(...t) {
    const e = !Array.isArray(t[0]),
      ...
      r = t[3 + n],
      a = An(i, o, {
        mixer: ((l = o[0]), ((t) => "object" == typeof t && t.mix)(l) ? l.mix : void 0),
        ...r,
      });
    var l;
    return e ? a(s) : a;
    ...
    return class {
          ...
          !1 !== this.options.animate &&
            ...
            this.addEventListener(
              ...
              ({
                ...
                const i = this.options.transition || o.getDefaultTransition() || $r,
      ...
      update() {
        ...
        if (this.isUpdateBlocked())
          return (
            this.unblockUpdate(), this.clearAllSnapshots(), void this.nodes.forEach(kr)
          );
      ...
      resetTransform() {
        ...
        t &&
          ...
          (i(this.instance, s), (this.shouldResetTransform = !1), this.scheduleRender());
      }
      measure(t = !0) {
      ...
      removeTransform(t) {
        ...
        for (let t = 0; t < this.path.length; t++) {
          ...
          Oi(s, n.measurePageBox()),
            zi(e, n.latestValues, n.snapshot ? n.snapshot.layoutBox : void 0, s);
        }
          ...
          if (
            ...
            t && t.layout && 1 !== this.animationProgress
              ? ((this.relativeParent = t),
                ...
                Qs(this.relativeTargetOrigin, this.layout.layoutBox, t.layout.layoutBox),
      ...
      getClosestProjectingParent() {
        if (this.parent && !ui(this.parent.latestValues) && !hi(this.parent.latestValues))
        ...
        if (
          ((this.isProjectionDirty ||
            (null === (t = this.parent) || void 0 === t
              ...
              : t.isProjectionDirty)) &&
            (s = !1),
          n && (this.isSharedProjectionDirty || this.isTransformDirty) && (s = !1),
      ...
      setAnimationOrigin(t, e = !1) {
        ...
        const r = { x: { min: 0, max: 0 }, y: { min: 0, max: 0 } },
          ...
          c = Boolean(a && !u && !0 === this.options.crossfade && !this.path.some(Hr));
        let h;
        (this.animationProgress = 0),
          (this.mixTargetDelta = (e) => {
            ...
            Nr(o.x, t.x, n),
              ...
              this.relativeTarget &&
                ...
                (Qs(r, this.layout.layoutBox, this.relativeParent.layout.layoutBox),
              ...
              a &&
                ...
                (function (t, e, n, s, i, o) {
                  i
                    ? ((t.opacity = en(0, void 0 !== n.opacity ? n.opacity : 1, ki(s))),
                      (t.opacityExit = en(
      ...
      applyTransformsToTarget() {
        ...
        let { targetWithTransforms: e, target: n, layout: s, latestValues: i } = t;
        if (e && n && s) {
          if (
            this !== t &&
            this.layout &&
      ...
      getLead() {
        ...
        return (
          (e && (null === (t = this.getStack()) || void 0 === t ? void 0 : t.lead)) ||
          this
        );
      }
      getPrevLead() {
      ...
      getProjectionStyles(t = {}) {
        ...
        this.applyTransformsToTarget(),
          (s.transform = qi(this.projectionDeltaWithTransform, this.treeScale, r)),
  ...
  function Mr(t) {
    var e;
    const n =
      (null === (e = t.resumeFrom) || void 0 === e ? void 0 : e.snapshot) || t.snapshot;
  ...
  const $r = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
    Yr = (t) =>
      "undefined" != typeof navigator && navigator.userAgent.toLowerCase().includes(t),
    Xr = Yr("applewebkit/") && !Yr("chrome/") ? Math.round : Ut;
  function Gr(t) {
    (t.min = Xr(t.min)), (t.max = Xr(t.max));
  }
  function qr(t, e, n) {
    return "position" === t || ("preserve-aspect" === t && !qs(Xi(e), Xi(n), 0.2));
  }
  const Zr = Cr({
  ...
  class ia extends o.default.Component {
    ...
    getSnapshotBeforeUpdate(t) {
      const { layoutDependency: e, visualElement: n, drag: s, isPresent: i } = this.props,
        o = n.projection;
      return o
        ? ((o.isPresent = i),
  ...
  const ka = {
      Group: e.forwardRef(function (
        { children: t, as: n = "ul", axis: s = "y", onReorder: o, values: r, ...a },
        l
      ) {
        const u = Bt(() => ha(n)),
          c = [],
        ...
        const d = {
          ...
          updateOrder: (t, e, n) => {
            ...
            c !== s &&
              ((h.current = !0), o(s.map(Ta).filter((t) => -1 !== r.indexOf(t))));
          },
        };
        return (
          e.useEffect(() => {
    ...
    const e = new Set(),
      n = {
        ...
        set: (n) => (
          ...
          e.forEach((t) => {
            !(function (t, e) {
              Array.isArray(e) ? Es(t, e) : "string" == typeof e ? Es(t, [e]) : ws(t, e);
            })(t, n);
          })
        ),
        stop() {
  ...
  function Ka(t) {
    Kr.current && ((Kr.current.isUpdating = !1), Kr.current.blockUpdate(), t && t());
  }
  const _a = (t, e) => `${t}: ${e}`,
    Ja = new Map();
  function Qa(t, e, n, s) {
  ...
  class el extends To {
    ...
    makeTargetAnimatableFromInstance({ transition: t, transitionEnd: e, ...n }) {
      return bs(this, n, As(n, t || {}, this)), { transition: t, transitionEnd: e, ...n };
    }
  }
  ...
  (t.AnimatePresence = ({
    ...
    return (
      ...
      i.createElement(i.Fragment, null, p.size ? m : m.map((t) => e.cloneElement(t)))
    );
  }),
    ...
    (t.LazyMotion = function ({ children: t, features: n, strict: s = !1 }) {
      ...
      return (
        ...
        i.createElement(h.Provider, { value: { renderer: r.current, strict: s } }, t)
      );
    }),
    (t.MotionConfig = function ({ children: t, isValidProp: n, ...s }) {
      n && yt(n), ((s = { ...e.useContext(r), ...s }).isStatic = Bt(() => s.isStatic));
      const o = e.useMemo(
        () => s,
    ...
    (t.useCycle = function (...t) {
      ...
      return [
        ...
        e.useCallback(
          (e) => {
            (n.current = "number" != typeof e ? Bo(0, t.length, n.current + 1) : e),
              i(t[n.current]);
          },
          [t.length, ...t]
        ),
    ...
    (t.useForceUpdate = pa),
    (t.useInView = function (t, { root: n, margin: s, amount: i, once: o = !1 } = {}) {
